...
(0, _newFirebaseJs.listenForMessageChanges)((messagesArray)=>{
    (0, _displayJs.displayMessages)(messagesArray);
});
...
messageForm.addEventListener("submit", async (event)=>{
    ...
    try {
        const messagesArray = await (0, _newFirebaseJs.fetchMessagesFromFirebase)();
        ...
        audio.play();
        await (0, _newFirebaseJs.addMessageToFirebase)(userMessage, userName, selectedColor);
        event.target.reset();
...
},{"./newFirebase.js":"3pLcT","./display.js":"lA8tp","./profanity.js":"6NBfr","8cf284e6b8936bcb":"ftRV4"}],"3pLcT":[function(require,module,exports,__globalThis) {
        ...
        user.addEventListener("click", async (event)=>{
            ...
            if (!messageDiv.querySelector(".ban-button")) {
                ...
                banButton.addEventListener("click", async (event)=>{
                    ...
                    if (confirmBan) {
                        await (0, _newFirebaseJs.patchBanned)(firebaseID, true);
...
},{"./newFirebase.js":"3pLcT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6NBfr":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
//# sourceMappingURL=slutprojekt-G6.135449a8.js.map
